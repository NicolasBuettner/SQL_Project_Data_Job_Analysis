...
The data for this analysis is from Luke Barousse’s SQL Course ([course link](https://www.lukebarousse.com/sql)). This data includes details on job titles, salaries, locations, and required skills. 
